...
const CustomizeProducts = () => {
  return (
    <div className="flex flex-col gap-6">
      ...
      <ul className="flex items-center gap-3">
        <li className="ring-1 ring-poke text-poke rounded-md py-1 px4 text-sm cursor-pointer ">Elite Trainer Box</li>
        <li className="ring-1  ring-pink-200 text-white bg-pink-200 rounded-md py-1 px4 text-sm cursor-not-allowed ">PokeCenter</li>
